...
Servo myServo;
Stepper AssembStepper(stepsPerRevolution, 5, 6, 9, 10);
...
void move_to_column(int targetCol) {
  ...
  while (true) {
   ...
   if(targetCol == 0)
   {
    AssembStepper.step(COL1);
   }  
   if(targetCol == 1)
   {
    AssembStepper.step(COL2);
   }
   if(targetCol == 2)
   {
    AssembStepper.step(COL3);
   }
   if(targetCol == 3)
   {
    AssembStepper.step(COL4);
   }
   if(targetCol == 4)
   {
    AssembStepper.step(COL5);
   }
   if(targetCol == 5)
   {
    AssembStepper.step(COL6);
   }
   if(targetCol == 6)
   {
    AssembStepper.step(COL7);
   }
