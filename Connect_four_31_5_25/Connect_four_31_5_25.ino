...
ButtonThreshold analogButtons[] = {
  { "Button1_10k", int(1023.0 * 100000.0 / (12500.0 + 100000.0)) },  // ~931
...
void Init_motor() {
  ...
  AssembStepper.setMaxSpeed(550);
  AssembStepper.setAcceleration(240);
...
void voltar_para_inicio() {
  ...
  AssembStepper.setMaxSpeed(550);
  AssembStepper.setAcceleration(250);
  AssembStepper.moveTo(-10000);
...
void setup() {
  ...
  //stepper
  AssembStepper.setMaxSpeed(550.0);
  AssembStepper.setAcceleration(300.0);
